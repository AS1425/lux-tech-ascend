...
const MissionVision = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-background pt-24 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground">
            Our <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Mission & Vision</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center glow-purple">
      ...
      <section className="bg-background py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:order-1 flex justify-center">
            <div className="relative">
              <div className="w-64 h-64 bg-gradient-to-br from-secondary to-primary rounded-full flex items-center justify-center glow-magenta">
      ...
      <section className="bg-muted/30 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow card-hover bg-card">
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button asChild className="bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-lg">
